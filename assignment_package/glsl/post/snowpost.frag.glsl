...
void main()
{
    ...
    vec3 noisePos = vec3(fs_UV.x * 8.f, fs_UV.y * 6.f, u_Time * 0.001f);
    float snowNoise = clamp(0.2 - worley(noisePos, 1.f, false).x, 0, 1);
    out_Col += snowNoise * u_Weather;
}
