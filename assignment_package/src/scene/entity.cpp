...
Entity::Entity(glm::vec3 pos)
    : m_forward(0,0,-1), m_right(1,0,0), m_up(0,1,0), m_position(pos), mcr_prev_position(pos), mcr_position(m_position)
{}

Entity::Entity(const Entity &e)
    : m_forward(e.m_forward), m_right(e.m_right), m_up(e.m_up), m_position(e.m_position), mcr_prev_position(e.mcr_prev_position), mcr_position(m_position)
{}
...
glm::vec3 Entity::getPrevPosition() {
    return mcr_prev_position;
}


void Entity::moveAlongVector(glm::vec3 dir) {
    mcr_prev_position = m_position;
    m_position += dir;
}
